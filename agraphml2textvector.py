...
for Id in room_ids:
    ...
    for edge_1 in graph.findall(namespace + 'edge'):
        ...
        if source_id_1 == Id and count == 0:
            ...
            conn = []
            guid_row = []
            for edge_2 in graph.findall(
                    namespace + 'edge'):  # finds all the target rooms and edgetypes for a unique source room
            ...
            conn.append(source.lower() + ' ' + 'connects with' + ' ' + converttostr(target_list,
                                                                                    ',') + ' ' + 'using' + ' ' + converttostr(
                edge_list, ','))
